...
The v1 to v2 contrast is the project's central result. Effect size went from 0.03 mV to 1.94 mV,
a 94x increase from a single sampling change.
...
approximately 40-50 s for tissues of 40-232 cells, not 117.2 s. The published figure was inflated by
...
v2: MPNN 1.070 vs MLP 3.008, a 2.81x advantage. The MLP early-stops at epoch 35 (ceiling
...
- OOD cross-tabulation by family x perturbed channel. Revealed the 6.5x difficulty spread
  behind D7.
- Within-graph vs across-graph target variance. The measurement that exposed
